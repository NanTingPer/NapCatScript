...
/// </summary>
public class SelectedLinkViewLocator : IDataTemplate
{
    static SelectedLinkViewLocator()
    {
        ViewModelMap.Add(typeof(HttpServerViewModel), typeof(LinkHttpServerView));
        ViewModelMap.Add(typeof(WebSocketServerViewModel), typeof(LinkWebSocketServerView));
    }
